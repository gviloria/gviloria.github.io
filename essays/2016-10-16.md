...
I am confident that if I were to recreate my JEE web app in Meteor, the difference in the amount of code would probably be in the hundreds. If only I knew about Meteor sooner. Just like UI frameworks, Meteor is an outstanding time-saver. 
